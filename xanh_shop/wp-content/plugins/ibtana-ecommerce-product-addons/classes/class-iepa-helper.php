...
if ( ! class_exists( 'IEPA_Helper' ) ) {
	...
	final class IEPA_Helper {
		...
		public function block_assets() {
			...
			if ( 'enabled' === self::$file_generation ) {
				...
				if ( isset( $file_handler['css_url'] ) ) {
					wp_enqueue_style( 'iepa-style', $file_handler['css_url'], array(), IEPA_VER, 'all' );
				} else {
					self::$fallback_css = true;
				}

				if ( isset( $file_handler['js_url'] ) ) {
					wp_enqueue_script( 'iepa-script', $file_handler['js_url'], array(), IEPA_VER, true );
				} else {
		...
		public function print_stylesheet() {
			...
			ob_start();
			?>
			<style id="iepa-style-frontend"><?php echo self::$stylesheet; //phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped ?></style>
			<?php
			ob_end_flush();
		}
		...
		public function get_block_css_and_js( $block ) {
			...
			switch ( $name ) {
				...
				// case 'iepa/ibtana-visual-editorbtn':
				// 	$css += IEPA_Block_Helper::get_button_css( $blockattr, $block_id );
				// 	IEPA_Block_JS::get_button_gfonts( $blockattr );
				// 	break;
				//
				// case 'iepa/page-title':
				// 	$css += IEPA_Block_Helper::get_page_title_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/google-map':
				// 	$css += IEPA_Block_Helper::get_google_map_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/gallery':
				// 	$css += IEPA_Block_Helper::get_image_gallery_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/icon':
				// 	$css += IEPA_Block_Helper::get_icon_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/separator':
				// 	$css += IEPA_Block_Helper::get_separator_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/progress-bar':
				// 	$css += IEPA_Block_Helper::get_progress_bar_css( $blockattr, $block_id );
				// 	IEPA_Block_JS::get_progress_bar_gfonts( $blockattr );
				// 	break;
				//
				// case 'iepa/ibtana-visual-editorheading':
				// 	$css += IEPA_Block_Helper::get_advanced_text_css( $blockattr, $block_id );
				// 	IEPA_Block_JS::get_advanced_text_gfonts( $blockattr );
				// 	break;
				//
				// case 'iepa/carousel':
				// 	$css += IEPA_Block_Helper::get_multiblock_slider_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/carouselimage':
				// 	$css += IEPA_Block_Helper::get_multiblock_slider_image_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/tabs':
				// 	$css += IEPA_Block_Helper::get_tabs_css( $blockattr, $block_id );
				// 	IEPA_Block_JS::get_tabs_gfonts( $blockattr );
				// 	break;
				//
				// case 'iepa/accordion':
				// 	$css += IEPA_Block_Helper::get_accordion_css( $blockattr, $block_id );
				// 	IEPA_Block_JS::get_accordion_title_gfonts( $blockattr );
				// 	break;
				//
				// case 'iepa/pane':
				// 	$css += IEPA_Block_Helper::get_accordion_pane_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/form-field-checkbox':
				// 	$css += IEPA_Block_Helper::get_form_checkbox_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/form-field-date':
				// 	$css += IEPA_Block_Helper::get_form_date_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/form-field-email':
				// 	$css += IEPA_Block_Helper::get_form_email_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/form-field-name':
				// 	$css += IEPA_Block_Helper::get_form_name_css( $blockattr, $block_id );
				// 	break;
				//
				// case 'iepa/form-field-number':
				// 	$css += IEPA_Block_Helper::get_form_number_css( $blockattr, $block_id );
				// 	break;
				// case 'iepa/form-field-phone':
				// 	$css += IEPA_Block_Helper::get_form_phone_css( $blockattr, $block_id );
				// 	break;
				// case 'iepa/form-field-radio':
				// 	$css += IEPA_Block_Helper::get_form_radio_css( $blockattr, $block_id );
				// 	break;
				// case 'iepa/form-field-select':
				// 	$css += IEPA_Block_Helper::get_form_select_css( $blockattr, $block_id );
				// 	break;
				// case 'iepa/form-field-text':
				// 	$css += IEPA_Block_Helper::get_form_text_css( $blockattr, $block_id );
				// 	break;
				// case 'iepa/form-field-textarea':
				// 	$css += IEPA_Block_Helper::get_form_textarea_css( $blockattr, $block_id );
				// 	break;
				// case 'iepa/form-field-url':
				// 	$css += IEPA_Block_Helper::get_form_url_css( $blockattr, $block_id );
				// 	break;
				// case 'iepa/button-single':
				// 	$css += IEPA_Block_Helper::get_form_button_css( $blockattr, $block_id );
				// 	break;
