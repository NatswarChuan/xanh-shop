...
class IEPA_Whizzie {
	...
	public function iepa_wizard_page() {
			...
			<div class="iepa-container iepa-flex iepa-templates-header-container">
				...
				<div class="iepa-top-links">
					<p class="iepara-theme-version">
						<strong>
							<?php
								esc_html_e( 'v' . IEPA_VER, IEPA_TEXT_DOMAIN );
							?>
						</strong>
					</p>
					<p>
						<img src="<?php echo esc_url( IEPA_URL . 'IEPA_Whizzie/assets/img/lightning.svg' ); ?>" class="iepara-lightning-icon"> <?php esc_html_e('Lightning Fast &amp; Fully Customizable WordPress theme!', IEPA_TEXT_DOMAIN ); ?>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="iepa-wrap">
			...
			echo '<div class="card iepa-whizzie-wrap">';
				// The wizard is a list with only one item visible at a time
				$steps = $this->get_steps();
				echo '<ul class="iepa-whizzie-menu">';
				...
				echo '</ul>';
				echo '<ul class="iepa-whizzie-nav">';
					foreach( $steps as $step ) {
	...
	public function get_steps() {
		...
		$steps = array(
			...
			'done' => array(
				...
				'view'			=> 'get_step_done',
				'callback'		=> '',
				'button_text'	=> __( 'Go To Ibtana Templates', IEPA_TEXT_DOMAIN ),
			)
		);
	...
	public function get_step_intro() {
		...
		$content['summary'] = sprintf(
			'<p>%s</p>',
			'Thank you for choosing Ecommerce Product Addons. To setup your product page click start now. It should only take a couple of minutes to go through all the steps.',
			IEPA_TEXT_DOMAIN
		);
		// $content['summary'] .= sprintf(
		// 	'<p>%s</p>',
		// 	'Click the button below to get started. If you decide not to go through the wizard now, you can return to this page any time you like.',
		// 	IEPA_TEXT_DOMAIN
		// );
		return $content;
	}
	...
	public function get_step_done() {
		$content = array();
		// The summary element will be the content visible to the user
		// $content['summary'] = sprintf( '<p>%s</p>', 'Finished.', IEPA_TEXT_DOMAIN );

		$content['summary'] = sprintf( '<p>%s</p>', 'You can check our free and premium ibtana templates.', IEPA_TEXT_DOMAIN );

		// $content['summary'] .= sprintf(
		// 	'<a class="button button-primary" href="' . admin_url( 'admin.php?page=ibtana-visual-editor-templates' ) . '">%s</a>',
		// 	'Go to Templates',
		// 	IEPA_TEXT_DOMAIN
		// );
