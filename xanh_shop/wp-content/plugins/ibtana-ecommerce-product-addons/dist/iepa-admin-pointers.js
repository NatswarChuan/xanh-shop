(function( $ ) {
      ...
      buttons: function( event, t ) {
        ...
        if ( pointer_options.button_dismiss ) {
          ...
          button_dismiss.on( 'click.pointer', function(e) {
            ...
            e.preventDefault();
            iepa_update_tutorial_status( pointer_options.step, function( iepa_res ) {
  ...
  function iepa_update_tutorial_status( step, callback ) {
    jQuery.post( wp.ajax.settings.url, {
      action: 'iepa_update_tutorial_status',
