          ...
          jQuery( '#ibtana-modal-btns-wrap' ).append(
            `<div class="components-panel__row">
              <p id="iepa_product_metabox_license_top" class="iepa_product_metabox_license">
                ...
                <a class="button" href="` + ibtana_visual_editor_modal_js.adminUrl + `admin.php?page=ibtana-visual-editor-addons" target="_blank">Upgrade To Pro!</a>
              </p>
            </div>`
          );
        }
                ...
                ibtana_visual_editor_modal_js.adminAjax + '?action=ive_ajax_save_template', {
                  ...
                  if ( resp.status == true ) {
                    ...
                    if ( !resp.is_add_on_providing_template_limit ) {
                      $( '.ive_trial_notice a' ).show();
                    } else {
                      $( '.ive_trial_notice a' ).hide();
                    }
                  } else {
                    // alert( resp.msg );
  ...
  window.onload = function() {
    ...
    var html = `<div class="UpcomingModal-content"><span class="CloseUpcomingModal">×</span>
        ...
        <div class="ibtana-modal-head">
            ...
            <div class="ibtana-modal-logo">
              ...
              <ul>
                <li>
                  <button class="tablinks active" data-tab-head="Templates">
                    <span class="dashicons dashicons-clipboard"></span>Templates
                  </button>
                </li>
                <li>
                  <button class="tablinks" data-tab-head="SavedTemplates">
                    <span class="dashicons dashicons-clipboard"></span>Saved Templates
                  </button>
                </li>
              </ul>
        		</div>
              ...
              <div>
                <div class="components-notice is-info">
                  <div class="components-notice__content">
                    ...
                    <a target="_blank" type="button" class="components-button is-primary is-small has-text has-icon" aria-label="Upgrade to Pro" style="display:none;">
                      Get Pro
                    </a>
                  </div>
                </div>
    ...
    function get_ibtana_visual_editor_defaults() {
      $.ajax({
        ...
        if ( data.data.hasOwnProperty('get_pro_permalink') ) {
          ...
          $( '.ive_trial_notice a' ).attr( 'href', data.data.get_pro_permalink );
        }
    ...
    $('#reload--modal--contents').on('click', function() {
      ...
      if ( jQuery('#Templates .theme-tab-list-two.active').attr('data-template-type') === undefined ) {
        ...
        jQuery( '#' + jQuery('.tablinks.active').attr('data-tab-head') + ' .theme-tab-list-two.active' ).trigger('click');
      }
    });
