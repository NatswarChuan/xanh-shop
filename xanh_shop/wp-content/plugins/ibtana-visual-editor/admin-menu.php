   ...
   */
			...
			<div class="ive-get-started-container">
				<div class="ive-get-started-row">
					...
					<div class="ive-get-started-col-6 ive-get-started-head-text">
						...
						<a href="<?php echo esc_url(admin_url().'admin.php?page=ibtana-visual-editor-templates') ?>">View Demos</a></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="ive-get-started-container ive-get-started-main-container">
				<div class="">
					...
					<div class="ive-get-started-blocks-accordion">
						<button class="ive-block-accordion-btn">Ibtana Blocks<span class="dashicons dashicons-arrow-down"></span></button>
						<div class="panel ive-get-started-block-activation">
							<?php
								...
								<div class="ive-get-started-row">
									...
									<span class="ibtana-block-demo-tooltip"><a target="_blank" href="<?php echo esc_url($ive_bock['ive_block_demo']) ?>">View Demo</a></span>
								</div>
							<?php } ?>
						</div>
						<button class="ive-block-accordion-btn">Woocommerce Blocks<span class="dashicons dashicons-arrow-down"></span></button>
						<div class="panel ive-get-started-block-activation">
							<?php
								$ive_block_json = file_get_contents(plugin_dir_url(__FILE__).'ive-blocks.json');
								$ive_blocks = json_decode($ive_block_json, true);
								...
								<div class="ive-get-started-row">
									<div class="ive-get-started-col-7 ive-get-started-block-title">
										<b><?php esc_html_e($ive_bock['iepa_block_title'],'ibtana-visual-editor'); ?></b>
										<p>
											<?php echo esc_html($ive_bock['iepa_block_text'],'ibtana-visual-editor'); ?>
										</p>
									</div>
									<span class="ibtana-block-demo-tooltip"><a target="_blank" href="<?php echo esc_url($ive_bock['ive_block_demo']) ?>">View Demo</a></span>
								</div>
    ...
    */
	function ibtana_visual_editor_load_custom_wp_admin_style() {
		...
		// Admin Menu style
		wp_register_style( 'ive-admin-menu', plugin_dir_url(__FILE__).'dist/css/ibtana-menu-css/ive-admin-menu.css', false, IVE_VER );
	...
	public function ibtana_visual_editor_general_settings_page() {
	  ...
	  if ( $iepa_key ) {
		...
		<div class="ive-get-started-container ive-get-started-main-container">
			...
			<div class="ive-get-started-sidebar-css-gen">
				<h4>
					<span class="dashicons dashicons-location-alt"></span><?php esc_html_e( 'Google API Key', 'ibtana-visual-editor' ); ?>
				</h4>
				<p>
			...
			<div class="ive-get-started-sidebar-css-gen">
				<h4>
					<span class="dashicons dashicons-editor-code"></span><?php esc_html_e( 'Custom CSS', 'ibtana-visual-editor' ); ?>
				</h4>
				<?php if ( !$is_iepa_activated ): ?>
					<p>
						...
						<a target="_blank" href="<?php echo admin_url( 'admin.php?page=ibtana-visual-editor-addons' ); ?>"><?php esc_html_e( 'Upgrade Pro', 'ibtana-visual-editor' ); ?></a>
					</p>
				<?php endif; ?>
			...
			<div class="ive-get-started-sidebar-css-gen">
				<h4>
					<span class="dashicons dashicons-editor-code"></span><?php esc_html_e( 'Custom JS', 'ibtana-visual-editor' ); ?>
				</h4>
				<?php if ( !$is_iepa_activated ): ?>
					<p>
						<?php esc_html_e( 'You need to activate your license to use this feature. To Enable This Feature', 'ibtana-visual-editor' ); ?>
						  ...
						  <div class="plugin-card-top">
						    <div class="name column-name">
						      <h3>
						        ...
						        <a href="<?php echo esc_url($plugin->permalink); ?>" target="_blank" class="plugin-name">
						          <img src="<?php if( isset($plugin->image) && ( $plugin->image != '' ) ) { echo $plugin->image; } else { echo IBTANA_PLUGIN_URI . 'dist/images/ibtana-setting-icon.svg'; } ?>" alt="WooCommerce Booking Integration" class="plugin-icon">
						        </a>
						      </h3>
						    </div>
						    <div class="action-links">
									<a target="_blank" href="<?php echo esc_url($plugin->permalink); ?>" type="button" class="button">
										<?php if ( property_exists( $plugin, 'price' ) && ( $plugin->price != '' ) ): ?>
											<?php echo '$' . $plugin->price . ' Buy Now!'; ?>
										<?php else: ?>
											<?php echo 'Get it Free!'; ?>
										<?php endif; ?>
									</a>
						    </div>
						    ...
						    <div class="card-footer">
									<?php if ( isset( $plugin->documentation ) && ( $plugin->documentation != '' ) ): ?>
										<a href="<?php echo esc_url( $plugin->documentation ); ?>" target="_blank">Documentation</a>
									<?php endif; ?>
						    </div>
						  </div>
						</div>
